...
<style>
    ...
    .bootstrap-scope .table-hover > tbody > tr:hover.firstRowTable {
        background-color: gray;
    }
...
<div>
    <h1 id="titleCurrency">Курсы Валют ЦБ</h1>
</div>
...
<script type="text/javascript">
    $(function () {
        $('input[id*="dtDatePicker"]').datepicker({ dateFormat: 'dd.mm.yy' });
        $("#dtDatePicker").val("01/06/2012");
    });
</script>
